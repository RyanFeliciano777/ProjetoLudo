...
void telaRegras02(){
    ...
    printf("%c da Peca * (Numero de Jogadores * 4 - Pe�as nao chegaram)). %c\n", 186, 186);
    printf("%c                                                            %c\n", 186, 186);
    printf("%c                                                            %c\n", 186, 186);
    printf("%c                                                            %c\n", 186, 186);
    printf("%c                                                            %c\n", 186, 186);
    ...
    int i,j;	
 	 ...
 	 for (i = 0; i < 31; i++) {
        for (j = 0; j < 61; j++){
        	...
        	//CONDI��O PRA PINTAR OS QUADRADOS DO TABULEIRO
